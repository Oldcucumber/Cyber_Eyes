...
```python
from vendor.minicpmo45.modeling_minicpmo_unified import MiniCPMO
...
```python
from backend.core.processors import UnifiedProcessor
from backend.core.schemas import ChatRequest, StreamingRequest, Message, Role
...
# ========== 离线双工 ==========
from backend.core.schemas.duplex import DuplexOfflineInput
...
```python
# 旧代码
from vendor.minicpmo45.modeling_minicpmo import MiniCPMOForCausalLM
...
```python
# 旧代码
from vendor.minicpmo45.modeling_minicpmo import MiniCPMODuplex
