...
class TestStreamingSchemas:
    ...
    def test_streaming_config_defaults(self):
        """StreamingConfig 默认值"""
        from backend.core.schemas import StreamingConfig
    ...
    def test_streaming_request_minimal(self):
        ...
        from backend.core.schemas import StreamingRequest
    ...
    def test_streaming_request_with_config(self):
        ...
        from backend.core.schemas import StreamingRequest, StreamingConfig
        request = StreamingRequest(
            session_id="test_002",
            messages=[Message(role=Role.USER, content="你好")],
            is_last_chunk=True,
    ...
    def test_streaming_chunk(self):
        """StreamingChunk"""
        from backend.core.schemas import StreamingChunk
    ...
    def test_streaming_response(self):
        """StreamingResponse"""
        from backend.core.schemas import StreamingResponse
...
class TestDuplexSchemas:
    ...
    def test_duplex_config_defaults(self):
        """DuplexConfig 默认值"""
        from backend.core.schemas import DuplexConfig
        config = DuplexConfig()
        assert config.generate_audio is True
    ...
    def test_duplex_prepare_request(self):
        ...
        from backend.core.schemas import DuplexPrepareRequest
    ...
    def test_duplex_prefill_request(self):
        ...
        from backend.core.schemas import DuplexPrefillRequest
    ...
    def test_duplex_generate_result(self):
        ...
        from backend.core.schemas import DuplexGenerateResult
