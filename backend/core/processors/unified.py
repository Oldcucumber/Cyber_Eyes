...
from backend.core.capabilities import ProcessorMode
from backend.core.processors.base import BaseProcessor, MiniCPMOProcessorMixin
...
if TYPE_CHECKING:
    from vendor.minicpmo45.modeling_minicpmo_unified import MiniCPMO, ProcessorMode as ModelProcessorMode
    ...
    def streaming_generate(
        ...
        try:
            ...
            for item in iter_gen:
                ...
                from backend.core.schemas.streaming import StreamingChunk
    ...
    def _chat_impl(
        ...
        if generate_audio and tts_config:
            ...
            if tts_config.sampling:
                from vendor.minicpmo45.utils import TTSSamplingParams as ModelTTSSamplingParams
...
class DuplexView:
    ...
    def offline_inference(self, task_input: "DuplexOfflineInput") -> "DuplexOfflineOutput":
        ...
        """
        from backend.core.schemas.duplex import DuplexOfflineInput, DuplexOfflineOutput, DuplexChunkResult
        import librosa
...
class UnifiedProcessor(BaseProcessor):
    ...
    def set_chat_mode(self) -> ChatView:
        ...
        Returns:
            ChatView instance.
        """
        from vendor.minicpmo45.modeling_minicpmo_unified import ProcessorMode as ModelProcessorMode
