...
```python
from backend.core.factory import ProcessorFactory
...
from backend.core.capabilities import ProcessorMode
from backend.core.processors import UnifiedProcessor, ChatView, HalfDuplexView, DuplexView
...
def create_processor(
    ...
    **kwargs
    ...
    示例:
        >>> from backend.core.factory import create_processor
        >>> from backend.core.capabilities import ProcessorMode
