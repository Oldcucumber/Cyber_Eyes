...
from backend.core.schemas.common import Message, Role, TTSConfig, TTSMode
...
# 2. 图像理解
from backend.core.schemas.common import ImageContent, TextContent
request = ChatRequest(
    messages=[
...
# 5. 批量推理
from backend.core.schemas.chat import BatchChatRequest
...
from backend.core.schemas.common import (
    Message,
    TTSConfig,
    GenerationConfig,
    ImageConfig,
